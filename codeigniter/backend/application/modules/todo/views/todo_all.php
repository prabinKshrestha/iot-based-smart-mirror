        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?php echo site_url('todo/todo_all_search') ?>" method="get" id="search_form">
            ...
            else
            {
                ...
                return false;
                        ...
                        <div class="table-responsive m-t-40">
                            <table id="exampsdle23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                <tr>
                                    <th>S.N</th>
                                    <th>Title</th>
