...
<head>
    ...
    <!-- page css -->
    <link href="templates/material/dist/css/pages/login-register-lock.css" rel="stylesheet">
    <!-- Custom CSS -->
...
<div class="preloader">
    <div class="loader">
        ...
        <p class="loader__label">CRM Loading</p>
    </div>
</div>
<!-- ============================================================== -->
<!-- Main wrapper - style you can find in pages.scss -->
<!-- ============================================================== -->
<section id="wrapper" class="login-register login-sidebar" style="background-image:url(templates/assets/images/background/login-register.jpg);">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal form-material" id="loginform" method="post" action="">
                <a href="javascript:void(0)" class="text-center db">
                    <br />
                    <img src="templates/assets/images/logo-text.png" width="100%" alt="CRM" />
                </a>
                <div class="form-group m-t-40">
                    <div class="col-xs-12">
                        <input class="form-control" type="text" name="username" value="<?php echo set_value('username');?>" required="" placeholder="Username">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control" name="passconf" value="" id="retype" type="password" required="" placeholder="Confirm Password">
                    </div>
                </div>
